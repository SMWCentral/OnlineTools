            ...
            .then((input) => {
                ...
                if (map16.error == null) {
                    ...
                    if (numDupes === 0) {
                        ...
                        smwc.setStatus({
                            success: `${map16.size} (0x${map16.size.toString(16).toUpperCase()}) tiles were found, of which ${numDupes} (0x${numDupes.toString(16).toUpperCase()}) ${numDupes === 1 ? "has" : "have"} ${minDupes} or more duplicates.`,
                        });
